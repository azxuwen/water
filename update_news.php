...
if(isset($_SESSION['User'])){
	//将题目和内容显示出来 并可以编辑
	$update_blog = "SELECT * FROM `news` WHERE id=$id";
...
<?php
	...
	if(@$_POST['submit_update']!=""){
		$add_update_blog = "UPDATE `news` SET title='$_POST[update_subject]',content='$_POST[update_body]',  time=now() WHERE id='$_POST[uid]'";
